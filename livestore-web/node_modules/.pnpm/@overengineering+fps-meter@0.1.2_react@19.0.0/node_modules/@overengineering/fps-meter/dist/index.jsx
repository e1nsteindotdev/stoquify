...
export const FPSMeter = ({ width = 120, height = 30, systemFps = 60, className }) => {
    ...
    const canvasRef = React.useCallback((canvas) => {
        ...
        if (numberOfFramesForAverageFps > numberOfVisibleFrames) {
            throw new Error(`numberOfFramesForAverageFps (${numberOfFramesForAverageFps}) must be smaller than numberOfVisibleFrames (${numberOfVisibleFrames}). Either increase the width or increase the resolutionInMs.`);
        }
        // eslint-disable-next-line unicorn/no-new-array
        const frames = new Array(numberOfVisibleFrames).fill(FRAME_UNINITIALIZED);
    ...
    return (<canvas width={adjustedWidth} height={adjustedHeight} className={className} ref={canvasRef} style={{ width, height }}/>);
};
