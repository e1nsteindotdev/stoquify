...
### AUTH 
    ...
    [ ] - just like how I used the custom auth function on createProduct convex mutation, do the same for all the other functions, add the resource and the action arguments to the function calls.
