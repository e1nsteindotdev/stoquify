            ...
            <div className="flex flex-col gap-3 overflow-y-scroll h-[350px]">
              {cart.size === 0 ? (
                <div className="w-full">
                  {" "}
                  <p className="mx-auto italic text-[14px]">
                ...
                Array.from(cart.keys()).map((key) => {
                  ...
                  return (
                    <div
                      key={key}
                      className="border-t-1 border-black flex pt-3 gap-2 text-[14px]"
                    >
                      <img
                        src={
                      ...
                      <div className="w-full flex flex-col gap-2 justify-start">
                        ...
                        <button
                          onClick={() =>
                            removeProductFromCart(product._id as Id<"products">)
                          }
        ...
        <SheetFooter>
          <div className="flex flex-col gap-8">
            <div className="border-t-1 border-black pt-3 px-2">
              <div className="pb-2">
                <p className="font-primary font-display text-primary leading-tighter text-[20px]">
                  COÛT TOTAL
                </p>
                <p className="text-[25px] font-black leading-tighter leading-[0.7]">
                  {totalCost} DZD
                </p>
              </div>
              ...
              <p className="text-[12px] opacity-40">
                ...
                <span className="text-[12px]">
                  {" "}
                  (pour Alger){" "}
                  <button className="underline text-black/80 italic ">
                    {" "}
                    changer de wilaya{" "}
                  </button>{" "}
                </span>
            ...
            <div className="w-full flex flex-col gap-3">
              <Link to={"/checkout"} type="submit" className="w-full">
                <Button className="rounded-3xl font-inter font-bold text-white w-full py-4">
                  COMMANDER MAINTENANT
                </Button>
              </Link>
              <SheetClose asChild>
                <Button className="bg-red-200 hover:bg-red-300 text-[#D20909] rounded-3xl">
                  Fermer
                </Button>
              </SheetClose>
            </div>
