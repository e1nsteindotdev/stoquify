...
import { useCollections } from "@/lib/useProducts";
      ...
      <div className="flex flex-col items-center gap-3 px-4 lg:px-20 border-l-1 border-r-1 border-seperator h-full pt-5 pb-7">
        <div className="flex flex-col items-center gap-1">
          <div className="flex gap-4 items-center text-[10px] lg:text-[12px] text-black/50">
            <p className="font-inter font-bold  tracking-[0.07em] uppercase">
          ...
          <p className="text-[20px] uppercase lg:max-w-[424px] text-center leading-tight">
            La collection MAMMA MIA 2025 s'inspire de la chanson vidéo d'Abba de
            1975
          </p>
        </div>
