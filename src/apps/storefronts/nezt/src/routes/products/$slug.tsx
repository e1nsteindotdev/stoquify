...
import { useProductById } from "@/lib/useProducts";
  ...
  return (
    ...
    >
      <div className="px-3 lg:px-4 max-w-[1800px] mx-auto bg-[#E6E6E6] relative">
        <div
          className={cn(
            "lg:h-[90px] border-l-1 border-r-1 border-white bg-[#E6E6E6] top-0 z-100",
            isCartOpened ? "lg:static" : "lg:sticky",
          )}
        >
          <HeaderAnonc />
          <Navbar />
          ...
          <div className="relative">
            <div className="flex flex-col lg:flex-row w-full lg:justify-center gap-x-4 lg:pb-100">
              ...
              <div className="relative">
                <div
                  className={cn(
                    "flex flex-col gap-6 lg:top-[120px] lg:h-[1000px] lg:sticky",
                  )}
                >
                  {/* desktop */}
                            ...
                            <div className="flex flex-col gap-2 p-3">
                              ...
                              <div className="flex gap-3">
                                {variant.options.map((option, idx) => (
                                  <button
                                    key={`${variant.id}-${option}-${idx}`}
                                    onClick={() => {
                                      setSelectedVariants((prev) => {
                                        prev.set(variant.id, {
                                          variantOptionName: option,
                                          variantOptionId: `${variant.id}-${option}`,
                                        });
                                        return new Map(prev);
                                      });
                                    }}
                                    ...
                                    ${
                                      selectedVariants.get(variant.id)
                                        ?.variantOptionName === option
