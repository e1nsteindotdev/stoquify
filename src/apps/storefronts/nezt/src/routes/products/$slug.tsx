                ...
                <div className={cn('flex flex-col gap-6 lg:top-[120px] lg:h-[1000px] lg:sticky')}>
                  ...
                  <div className='flex flex-col gap-4 items-center lg:items-start px-3 lg:px-0'>
                    ...
                    <div className='flex flex-col border-white border-1 w-full lg:w-auto'>
                      ...
                      <div className='flex flex-col gap-2 p-3'>
                        <p className='text-primary text-[18px] font-bold uppercase'>Quantité</p>
                    ...
                    <div className='mb-20 w-full flex flex-col gap-4 pt-8 lg:pt-20'>
                      ...
                      <p className='uppercase text-[12px] lg:text-[16px] text-black/40 uppercase font-inter italic text-center lg:text-start'>LIVRAISON 48H MAXIMUM</p>
                    </div>
                  </div>
...
function FuckingButton({ handleSubmit }: { handleSubmit: any }) {
  ...
  useEffect(() => {
    ...
    const cancel = setTimeout(() => { setClicked(false) }, 3000)
  ...
  return (
    ...
    >
      <div className='h-[23px]'>
        <AnimatePresence>
          <motion.div
            key={clicked ? "clicked" : "not_clicked"}
            initial={{ opacity: 0, x: clicked ? 100 : -100 }}
            animate={{
              opacity: 1,
              x: 0,
              transition: {
            ...
            exit={{ opacity: 0, z: clicked ? -100 : 100, transition: { duration: 0.4 } }}
          >
            {clicked ?
              <div className='flex gap-3 justify-center items-center'>
                <p className='leading-[1] pt-1.25'>TERMINÉ</p>
                <Check color='white' className='size-5 stroke-white' strokeWidth={3} />
              </div>
              :
              <div className='flex gap-3 justify-center items-center'>
                <p className='leading-[1] pt-1.25 font-bold'>Ajouter au panier</p>
                <CartIcon color='white' className='stoke-white mt-1.25' size={16} />
              </div>
            }
          </motion.div>
        </AnimatePresence>
