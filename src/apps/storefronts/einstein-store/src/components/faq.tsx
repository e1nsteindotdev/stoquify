  ...
  return (
    <div className="w-full py-6">
      <div className="flex justify-center">
        <p className="relative uppercase text-primary text-[41px] lg:text-[103px] font-display tracking-tighter inline">Questions fréquentes
          <span
            className="absolute font-display -left-8 lg:-left-18 lg:bottom-[22px] bottom-[8px] text-[19px] lg:text-[47px] text-black/20 font-bold tracking-[-0.06em]">04</span>
        </p>
      </div>
...
function Question({ children }: { children: string }) {
  return (
    <div className="flex items-center w-full justify-between py-3 px-4">
      <p className="uppercase text-black text-[18px] font-semibold font-inter">{children}</p>
