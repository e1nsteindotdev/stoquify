        ...
        {categories?.map((c, i) => (
          <div className={`flex flex-col lg:flex-row w-full lg:border-b-1 lg:border-white ${i % 2 === 0 && "justify-end"}`}>
            <div className="flex xs:justify-between gap-3 lg:gap-5 py-5 px-3 lg:px-5">
              <div className={`flex flex-col gap-1.5 lg:gap-3 w-[200px]  ${i % 2 === 0 ? "order-1 items-end" : "order-2 item-start"}`}>
                ...
                <div className="flex flex-col justify-between gap-2 h-full">
                  <div className={`text-black/20 font-inter font-semibold text-[10px] lg:text-[16px] flex flex-col gap-0.25 uppercase h-[160px] lg:h-[300px] overflow-clip 
                    ...
                    <p>airmax blue nuit</p>
                    <p>TN white white</p>
                    <p>new balance light green</p>
                    <p className="text-black">Nike air beige </p>
                    <p>adidas samba black</p>
                    <p>Adidas sl 76 og</p>
                    <p>nike pk 88 gl</p>
                    <p>Adidas NG MARATHON SPZL  </p>
                    <p>ADIDAs LG ACHILLE SPZL</p>
                  </div>
              ...
              <div className={`relative bg-[#F1F1F1] h-[230px] w-[184px] xs:h-full xs:w-full lg:w-[390px] lg:h-[490px] border-1 border-white ${i % 2 === 0 ? "order-2" : "order-1"}`}>
