/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6f45b4056317dffb23be8f2ef232196b)
// Runtime types generated with workerd@1.20250803.0 2025-05-08 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CONVEX_DEPLOYMENT: string;
		CONVEX_URL: string;
		WEBSOCKET_SERVER: DurableObjectNamespace<import("./src/index").WebSocketServer>;
		CLIENT_DO: DurableObjectNamespace<import("./src/index").LiveStoreClientDO>;
		DB: D1Database;
		LIVE_DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONVEX_DEPLOYMENT" | "CONVEX_URL">> {}
}
